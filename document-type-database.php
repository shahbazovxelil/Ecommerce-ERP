...
<head>
	...
	<!-- Title -->
	<title>Sənədin növü bazası</title>
                                                ...
                                                <div class="table-lg mt-3">
                                                    <form id="form_id" method="post">
                                                        <table class="table table-bordered border-top text-nowrap">
                                                            ...
                                                            <?php
                                                                $i=0;
                                                                foreach($document_type_dates as $document_type_date):
                                                                $i++;
                                                                if($document_type_date['name'] != ""):
                                                                ?>
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div>
                                                                                    <input type="text"
                                                                                        class="form-control"
                                                                                        name="name[]"
                                                                                        value="<?php echo $document_type_date['name']; ?>">
                                                                                </div>
                                                                            </div>
...
$("#form_id").on("submit", function (e) {
    ...
    if (document.querySelector("#form_id").checkValidity()) {
        $.ajax({
            url: 'controller/ajax_bank.php?tab=add_document_type_data',
            dataType: 'JSON',
            type: 'POST',
