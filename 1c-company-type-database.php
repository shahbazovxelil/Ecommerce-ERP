...
<head>
	...
	<!-- Title -->
	<title>1c Səlahiyyət şirkət növü bazası</title>
                                    ...
                                    <div class="e-panel card p-4">
                                        <div class="card-header justify-content-center">
                                            <div class="card-title">
                                                1C SƏLAHİYYƏT ŞİRKƏT NÖVLƏRİ BAZASI
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <div class="e-table">
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div>
                                                                                    <input type="text"
                                                                                        class="form-control"
                                                                                        name="name[]"
                                                                                        value="<?php echo $authority_company['name']; ?>">
                                                                                </div>
                                                                            </div>
...
$("#form_id").on("submit", function (e) {
    ...
    if (document.querySelector("#form_id").checkValidity()) {
        $.ajax({
            url: 'controller/ajax_bank.php?tab=add_authority_company',
            dataType: 'JSON',
            type: 'POST',
