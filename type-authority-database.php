...
<head>
	...
	<!-- Title -->
	<title>1c Səlahiyyət növü bazası</title>
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div>
                                                                                    <input type="text"
                                                                                        class="form-control"
                                                                                        name="name[]"
                                                                                        value="<?php echo $type_authority_data['name']; ?>">
                                                                                </div>
                                                                            </div>
...
$("#form_id").on("submit", function (e) {
    ...
    if (document.querySelector("#form_id").checkValidity()) {
        $.ajax({
            url: 'controller/ajax_bank.php?tab=add_type_authority_data',
            dataType: 'JSON',
            type: 'POST',
