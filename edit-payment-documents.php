...
$bank_branches = $connect->query("SELECT * FROM bank_branches")->fetch_all(MYSQLI_ASSOC);
...
<head>
	...
	<!-- Title -->
	<title>Ödəniş sənədini redaktə edin</title>
						...
						<div class="col-xl-12 col-lg-12">
							<div class="card">
								<div class="card-header justify-content-center">
									<div class="card-title ">ÖDƏNİŞ SƏNƏDİNİ REDAKTƏ EDİN</div>
								</div>
								<form id="form_id" class="needs-validation form" novalidate>
									<div class="card-body">
										...
										<div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <textarea type="text" name="appointment" height="400px" class="form-control" placeholder="Təyinatla bağlı məlumatı daxil edin..."><?php echo $payment['appointment']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
												...
												<div class="form-group">
                                                    ...
                                                    <div >
                                                        <select class="search-box" name="unit_measure"  required>
                                                            ...
                                                            <option selected="" disabled="">Seçiminizi edin...</option>

															<?php

														foreach($unit_measures as $unit_measure){?>

                                                            <option <?php if($payment['unit_measure']==$unit_measure['name']) echo "selected"; ?>><?php echo $unit_measure['name']; ?></option>
                                                        <?php }?>
                                                        </select>
                                            ...
                                            <div class="col-sm-12 col-md-2">
												<div class="form-group">
													...
													<div>
														<input autocomplete="off" type="number" name="quantity" value="<?php echo $payment['quantity']; ?>" class="form-control quantity" placeholder="Daxil edin..." required>
														<div class="invalid-feedback">Xana boş ola bilməz! </div>
													</div>
												</div>
											</div>
                                            <div class="col-sm-12 col-md-2">
												<div class="form-group">
													...
													<div>
														<input autocomplete="off" type="number" name="price" value="<?php echo $payment['price']; ?>" class="form-control price "placeholder="Daxil edin..." required value="">
														<div class="invalid-feedback">Xana boş ola bilməz! </div>
													</div>
												</div>
											</div>
												...
												<div class="form-group">
                                                    ...
                                                    <div>
                                                        <select class="search-box valyute" name="currency" required>
                                                            <option selected="" disabled="" >Valyutanı seçin...</option>
															<?php

                                                            foreach($currencies as $currency){?>

                                                            <option <?php if( $payment['currency']==$currency['name']) echo "selected"; ?>><?php echo $currency['name']; ?></option>
                                                        <?php }?>
                                                        </select>
                                                        <div class="invalid-feedback"> Xana boş ola bilməz! </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-12 col-md-3">
												<div class="form-group">
													...
													<div>
														<input autocomplete="off" type="text" name="total_amount" value="<?php echo $payment['total_amount']; ?>" class="form-control amount"placeholder="Daxil edin..." required readonly>
														<div class="invalid-feedback">Xana boş ola bilməz! </div>
													</div>
												</div>
											</div>
                                                    ...
                                                    <div>
                                                        <select class="search-box" name="payment_type" >
                                                            ...
                                                            <?php
                                                                ...
                                                                <option <?php if($payment['payment_type']== $payment_type['name']) echo "selected"; ?>><?php echo $payment_type['name']; ?></option>
                                                            <?php }?>
                                     ...
                                     $bankidtoname  = mysqli_query($connect,"SELECT * FROM banks WHERE id = {$payment['bank_name']}");
                                     $bankidto = mysqli_fetch_array($bankidtoname,MYSQLI_ASSOC);

														foreach($banks as $bank){?>

														<option value="<?php echo $bank['id']; ?>" <?php if($bankidto['name'] == $bank['name']) echo "selected"; ?>><?php echo $bank['name']; ?></option>
													<?php }?>
                                                        </select>
                                                        <div class="invalid-feedback">Xana boş ola bilməz! </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-12 col-md-4">
												<div class="form-group">
                                                    ...
                                                    <div>
														...
														foreach($bank_branches as $bank_branche){?>

                                                            <option  <?php if($payment['bank_branch']== $bank_branche['bank_branch_name']) echo "selected"; ?>><?php echo $bank_branche['bank_branch_name']; ?></option>
                                                            <?php }?>
                                                        </select>
                                                        <div class="invalid-feedback">Xana boş ola bilməz! </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <?php
															...
															<?php
																...
																{?>
																	 <option <?php if($payment['company_name']==$cmp) echo 'selected';   ?>><?php echo $cmp; ?></option>
																<?php }?>
															?>
                                                        </select>
                                                        <div class="invalid-feedback">Xana boş ola bilməz! </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <textarea type="text" name="note" class="form-control" placeholder="Əlavə qeydiniz varsa buraya yazın..."><?php echo $payment['note']; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
										</div>										
									...
									<div class="card-footer d-flex justify-content-end">
                                        <div class="btn-list btn-animation ms-1">
										    <button type="submit" form="form_id" class="btn btn-success">Düzəlişləri tamamla</button>
                                        </div>
            ...
            // console.log($(this).val());
                ...
                $("#form_id").on("submit", function (e) {
                    ...
                    if (document.querySelector("#form_id").checkValidity()) {
                        $.ajax({
                            url: 'controller/ajax_bank.php?tab=edit_payment&uid=<?php echo $uid;?>',
                            dataType: 'JSON',
                            type: 'POST',
